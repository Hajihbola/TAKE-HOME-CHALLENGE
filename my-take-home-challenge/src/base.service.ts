...
export class BaseService<T> {
  ...
  async findWithQuery(
    ...
    const query: SelectQueryBuilder<T> = this.repository.createQueryBuilder('entity');

    QueryUtils.applyPagination(query, { page, limit });
    QueryUtils.applyFilters(query, filters);
    QueryUtils.applySorting(query, sorts);
